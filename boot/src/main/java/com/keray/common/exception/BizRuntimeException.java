...
public class BizRuntimeException extends RuntimeException implements CodeException {
    ...
    public BizRuntimeException(ResultCode code, Exception exception) {
        this(code.getMessage(), exception, code.getCode());
    }

    public BizRuntimeException(String message) {
        this(message, CommonResultCode.settingError.getCode());
    }
